...
export const Appbar = ({ user, onSignin, onSignout }: AppbarProps) => {
  ...
  return (
    <div className="flex justify-between border  py-0.5 px-4 fixed top-2 left-0 right-0 z-50 max-w-7xl mx-auto rounded-lg w-full backdrop-blur-md bg-blue-200 bg-opacity-5 border-gray-1 00 mb-6">
