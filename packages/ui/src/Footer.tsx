...
const Footer: React.FC<FooterProps> = ({ year = new Date().getFullYear(), email = "pankajams1234@gmail.com" }) => {
  return (
      ...
      <div className="container mx-auto px-6 sm:px-12">
        ...
        <div className="flex flex-col items-center space-y-6 sm:space-y-0 sm:flex-row sm:justify-between">
          <div className="text-center sm:text-left">
            <p className="text-lg font-semibold mb-1">© {year} Flowpay. All rights reserved.</p>
            <p className="text-sm">
