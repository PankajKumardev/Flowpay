...
import { Wallet, TrendingUp, AlertCircle, ArrowUpRight, ArrowDownLeft, PieChart, HelpCircle } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div className="bg-white shadow-lg rounded-lg overflow-hidden">
            <div className="p-6 ">
              ...
              <p className="text-gray-600 mb-4 ">Transfer money to your contacts instantly.</p>
          <div className="pt-1">
          <a href="/p2p" className="bg-green-500 text-white px-3 py-3  rounded-lg hover:bg-green-600 transition-colors">
                Send Money
                </a>
          </div>
            </div>
          ...
          <div className="bg-white shadow-lg rounded-lg overflow-hidden">
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">Top up your FlowPay wallet easily.</p>
                <div className="pt-1">
                <a href="/transfer" className="bg-blue-500 text-white px-4 py-3 rounded-lg hover:bg-blue-600 transition-colors">
                Add Money
                </a>
                </div>
            </div>
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden mb-8">
          <div className="p-6">
            ...
            <a href="/transactions" className="text-purple-500 font-medium hover:text-purple-600 transition-colors">
